...
public class PowerConsumptionAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				String output = PowerConObj.createPowerConsumption(request.getParameter("id"),
						request.getParameter("accountNo"),
						request.getParameter("invoiceNo"),
						request.getParameter("userName"),
						request.getParameter("usedUnits"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = PowerConObj.updatePowerConsumption(
				paras.get("id").toString(),
				paras.get("accountNo").toString(),
				paras.get("invoiceNo").toString(),
				paras.get("userName").toString(),
				paras.get("usedUnits").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request);
		    String output = PowerConObj.deletePowerConsumption(paras.get("id").toString());
		response.getWriter().write(output);
	}
